...
if($validUsuarioYcontrasinal != 1){
    ...
    #Consuta á base de datos para obter a táboa equipos_alugado
    $consulta = mysqli_query($conn_db, "SELECT * FROM equipo_alugado");

    #Obetemos número de filas da táboa
    $numeroFilas = mysqli_num_rows($consulta);

    #Quedan elementos que mostrar na táboa equipo_alugado
    if($numeroFilas != 0){

    #Pintamos por pantalla os elementos da táboa alugado
    echo "
        <div class='container'>
        ...
        #Mostrar usuario
        echo "
            <h1 class=\"text-center\">Lista de equipamiento alugado</h1>
        ...
        foreach ($filas as $fila){
            ...
            echo
                "<tr>".
                    ...
                    #Enviamos polo método POST e de xeito oculto as variable que precisamos en modo Todos
                    "<form action='update/flow/rentedBulk.php' method='post'>".
                        ...
                        "</button>".
                    "</form>".
                    #Enviamos polo método POST e de xeito oculto as variable que precisamos en modo 1 a 1
                    "<form action='update/flow/rentedOnce.php' method='post'>".
                        "<input type='hidden' name='cantidade' value=\"".$fila['cantidade']."\">".
                        "<input type='hidden' name='modelo' value=\"".$fila['modelo']."\">".
                        "<input type='hidden' name='marca' value=\"".$fila['marca']."\">".
                        "<input type='hidden' name='foto' value=\"".$fila['foto']."\">".
