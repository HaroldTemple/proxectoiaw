...
if ($validUsuarioYcontrasinal != 1){
    ...
    #Consuta á base de datos para obter a táboa equipo_venda
    ...
    if($numeroFilas != 0){
                ...
                <div class='row col-md-6 col-md-offset-2 custyle'>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Cantidade</th>
                            <th>Imaxe</th>
                            <th class='text-center'>Mercar</th>
                        </tr>
                    </thead>
                </div>
            </div>
        ...
        #Mostrar usuario
        echo "
            <h1 class=\"text-center\">Lista de equipamento a venda</h1>
        ...
        foreach ($filas as $fila){
            ...
            echo
                "<tr>".
                    ...
                    "<form action='update/flow/sale.php' method='post'>".
