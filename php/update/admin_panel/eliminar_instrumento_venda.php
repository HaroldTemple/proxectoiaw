...
if ($validUsuarioYcontrasinal != 1){
    ...
    #Consuta a base de datos para obter a táboa equipos_venda
    $consulta = mysqli_query($conn_db, "SELECT * FROM equipo_venda");

    #Obter número de filas da táboa
    $numeroFilas = mysqli_num_rows($consulta);

    #Quedan elementos que mostrar na táboa equipo_venda
    if ($numeroFilas != 0){

    #Pintamos por pantalla os elementos da táboa venda
    echo "
        <div class='container'>
    ...
    #Mostramos usuario
    echo "
        <h1 class=\"text-center\">Lista de equipamiento en venda para eliminar</h1>
    ...
    foreach ($filas as $fila){
        ...
        echo
            "<tr>".
                ...
                "<form action='../flow/eliminar_instrumento_venda.php' method='post'>".
