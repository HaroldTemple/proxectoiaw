    ...
    echo "
        ...
        <div class=\"limiter\">
            <div class=\"container-login100\" style=\"background-image: url('../../../../images/bg-01.jpg');\">
                ...
                echo "</br>";
                echo "modifica </br> contrasinal
                </span>
                    <form class=\"login100-form validate-form p-b-33 p-t-5\" name=\"formulario\" method=\"post\"
                        action=\"../backend/contrasinal.php\">
                        <div class=\"wrap-input100 validate-input\" data-validate=\"contrasinal1\">
                            <input class=\"input100\" type=\"text\" name=\"contrasinal1\" placeholder=\"novo contrasinal\">
                            <span class=\"focus-input100\" data-placeholder=\"&#xe80f;\"></span>
                        </div>
                        <div class=\"wrap-input100 validate-input\" data-validate=\"contrasinal2\">
                            <input class=\"input100\" type=\"text\" name=\"contrasinal2\" placeholder=\"valida o contrasinal\">
                            <span class=\"focus-input100\" data-placeholder=\"&#xe802;\"></span>
                        </div>
