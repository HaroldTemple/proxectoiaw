    ...
    echo "
        ...
        <div class=\"limiter\">
            <div class=\"container-login100\" style=\"background-image: url('../../../../images/bg-01.jpg');\">
                ...
                echo "</br>";
                echo "modifica </br> dni
                </span>
                    <form class=\"login100-form validate-form p-b-33 p-t-5\" name=\"formulario\" method=\"post\"
                        action=\"../backend/dni.php\">
                        <div class=\"wrap-input100 validate-input\" data-validate=\"dni1\">
                            <input class=\"input100\" type=\"text\" name=\"dni1\" placeholder=\"novo dni\">
                            <span class=\"focus-input100\" data-placeholder=\"&#xe822;\"></span>
                        </div>
                        <div class=\"wrap-input100 validate-input\" data-validate=\"dni2\">
                            <input class=\"input100\" type=\"text\" name=\"dni2\" placeholder=\"valida o dni\">
                            <span class=\"focus-input100\" data-placeholder=\"&#xe802;\"></span>
                        </div>
