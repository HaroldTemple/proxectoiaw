    ...
    echo "
        ...
        <div class=\"limiter\">
            <div class=\"container-login100\" style=\"background-image: url('../../../../images/bg-01.jpg');\">
                ...
                echo "</br>";
                echo "modifica </br> enderezo
                </span>
                    <form class=\"login100-form validate-form p-b-33 p-t-5\" name=\"formulario\" method=\"post\"
                        action=\"../backend/enderezo.php\">
                        <div class=\"wrap-input100 validate-input\" data-validate=\"enderezo1\">
                            <input class=\"input100\" type=\"text\" name=\"enderezo1\" placeholder=\"novo enderezo\">
                            <span class=\"focus-input100\" data-placeholder=\"&#xe800;\"></span>
                        </div>
                        <div class=\"wrap-input100 validate-input\" data-validate=\"enderezo2\">
                            <input class=\"input100\" type=\"text\" name=\"enderezo2\" placeholder=\"valida o enderezo\">
                            <span class=\"focus-input100\" data-placeholder=\"&#xe802;\"></span>
                        </div>
